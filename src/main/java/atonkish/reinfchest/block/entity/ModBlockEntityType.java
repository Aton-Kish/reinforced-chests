...
public class ModBlockEntityType {
  public static final Map<ReinforcingMaterial, BlockEntityType<ReinforcedChestBlockEntity>>
      REINFORCED_CHEST_MAP = new LinkedHashMap<>();

  public static BlockEntityType<ReinforcedChestBlockEntity> registerMaterial(
    ...
    if (!REINFORCED_CHEST_MAP.containsKey(material)) {
      ...
      BlockEntityType<ReinforcedChestBlockEntity> blockEntityType =
          BlockEntityTypeInvoker.create(
              Identifier.of(namespace, id).toString(),
              (blockPos, blockState) ->
                  new ReinforcedChestBlockEntity(material, blockPos, blockState),
              block);
