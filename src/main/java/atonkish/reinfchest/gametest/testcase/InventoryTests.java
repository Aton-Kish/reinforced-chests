...
public class InventoryTests {
  private static final String TEST_ENVIRONMENT_DEFAULT =
      String.format("%s:inventory/default", ReinforcedChestsMod.MOD_ID);
  ...
  private static TestFunction createTestSingleChest(String name, ChestBlock chestBlock, int size) {
    Identifier testIdentifier =
        TestIdentifier.of(ReinforcedChestsMod.MOD_ID, InventoryTests.class, name);
    ...
    return new TestFunction(
        ...
        (context) -> {
          ...
          context.setBlockState(
              blockPos, chestBlock.getDefaultState().with(ChestBlock.CHEST_TYPE, ChestType.LEFT));
          context.setBlockState(
              blockPos.east(1),
