...
public class StatTests {
    ...
    private static void register(String name, ReinforcedChestBlock chestBlock) {
        String testName = String.format("%s: %s", StatTests.class.getSimpleName(), name);
        TEST_FUNCTIONS.add(new TestFunction(
                ReinforcedChestsModGameTest.BATCH_ID_STAT,
                testName,
